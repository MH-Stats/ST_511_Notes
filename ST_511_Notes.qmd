...
-   Nested models
    ...
    - Your reduceded model has to be inside your full model, otherwise it will create negative values that will impact the ability to calculate your test statistic
